...
const Stack: FunctionComponent = () => {
  return <div className={styles.skillset}>
    <h3>Stack:</h3>
    <div className={styles.skill}><b>Frontend:</b> JavaScript ◌ TypeScript ◌ React ◌ Redux ◌ MUI ◌ Antd ◌ RTK ◌ RTK Query ◌ Zustand ◌ Next.js ◌ SWR ◌ HTML5 ◌ CSS3 ◌ Sass preprocessor ◌ Webpack.</div>
    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.flexWrapper}>
          ...
          <object type="image/svg+xml" data="https://github-readme-stats.vercel.app/api/top-langs/?username=prg938&layout=compact&hide_border=true&theme=dark&langs_count=6" />
        </div>
        <Location />
        <Background />
        <Stack />
